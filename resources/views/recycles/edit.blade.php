<x-app-layout>
    <div class="container lg:w-1/2 md:w-4/5 w-11/12 mx-auto mt-8 px-8 bg-white shadow-md">
        ...
        <form action="{{ route('recycles.update', $recycle) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <img src="{{ $recycle->image_url }}" alt="" class="mb-4 md:w-2/5 sm:auto">
            ...
            <div class="mb-4">
                ...
                <textarea name="body" rows="10"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="本文">{{ old('body', $recycle->body) }}</textarea>
            </div>
            <div class="mb-4">
